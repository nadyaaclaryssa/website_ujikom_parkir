...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .section-title { font-size: 14px; font-weight: 800; margin-bottom: 25px; color: #1e293b; text-transform: uppercase; letter-spacing: 1px; }
    ...
    <div class="app-container">
        <div class="sidebar">
            ...
            <div class="storage-box">
                ...
                <a href="#" style="color: var(--primary); text-decoration: none; font-size: 11px; font-weight: 700; display: block; margin-top: 10px;">Upgrade Slot ↗</a>
            </div>
        ...
        <div class="main-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <p style="font-size: 11px; margin-top: 15px; color: #94a3b8;">Status: Aktif Sekarang</p>
                </div>
                <div class="stat-card">
                    <h3>Sisa Slot</h3>
                    <div class="val"><?= $sisa_slot ?></div>
                    <p style="font-size: 11px; margin-top: 15px; color: #94a3b8;">Kapasitas: 1350</p>
                </div>
                <div class="stat-card">
                    <h3>Total Petugas</h3>
                    <div class="val"><?= $total_petugas ?></div>
                    <p style="font-size: 11px; margin-top: 15px; color: #94a3b8;">Role: Petugas Aktif</p>
                </div>
            </div>
            ...
            <div class="table-card">
                <table>
                    ...
                    <tbody>
                        <?php
                        $q_log = mysqli_query($koneksi, "SELECT * FROM tb_transaksi ORDER BY waktu_masuk DESC LIMIT 5");
                        while($row = mysqli_fetch_assoc($q_log)) {
                        ?>
                        <tr>
                            <td style="font-weight: 700; color: #1e293b;"><?= $row['petugas'] ?? 'Sistem' ?></td>
                            ...
                            <td style="color: #64748b;"><?= date('d M, H:i', strtotime($row['waktu_masuk'])) ?></td>
                            <td style="font-weight: 800; color: #1e293b;">Rp <?= number_format($row['biaya_total'], 0, ',', '.') ?></td>
